"""
BPTT training entry point for first-order MBRL over the flow surrogate.
...
`emittance_target.diffrl.BPTT` UNCHANGED; only the env (FlowBunchEnv) differs.

Usage:
    python -m photoinjector_rl.surrogates.flow.train_bptt \
        --cfg configs/diff_rl/bptt_flow.yaml \
        ...
        --logdir logs/bptt_flow --seed 0 --max-epochs 200
"""
...
from photoinjector_rl.diffrl import BPTT
