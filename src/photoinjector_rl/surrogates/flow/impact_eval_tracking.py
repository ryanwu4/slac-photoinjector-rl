...
Usage:
  python -m photoinjector_rl.surrogates.flow.impact_eval_tracking \
...
def _run_impact(norm11: np.ndarray, constants: dict, workdir_root=None,
    ...
    from photoinjector_rl.impact.evaluate import custom_evaluate_impact_with_distgen
...
def _parse_args() -> argparse.Namespace:
    ...
    p.add_argument("--log-dir", default="runs/impact_eval")
    return p.parse_args()
