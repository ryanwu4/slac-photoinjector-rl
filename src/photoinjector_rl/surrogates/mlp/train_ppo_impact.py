...
from photoinjector_rl.core.callbacks import EpisodeMetricsCallback, RolloutDiagnosticCallback
...
def build_argparser() -> argparse.ArgumentParser:
    ...
    p.add_argument("--warm-start",
                   default="runs/ppo_emittance_target/eval/best_model.zip",
    ...
    p.add_argument("--norm-json", required=True,
                   help="path to the normalization JSON the surrogate "
                        ...
                        "value fn)")
    p.add_argument("--out-dir", default="runs/ppo_impact_emittance_target")
