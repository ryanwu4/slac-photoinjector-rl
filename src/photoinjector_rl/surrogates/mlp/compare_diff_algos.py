...
def _run_shac(args, seed: int, run_dir: Path) -> None:
    ...
    cmd = [
        sys.executable, "-m", "photoinjector_rl.surrogates.mlp.train_shac",
...
def _run_bptt(args, seed: int, run_dir: Path) -> None:
    ...
    cmd = [
        sys.executable, "-m", "photoinjector_rl.surrogates.mlp.train_bptt",
...
def _run_ppo(args, seed: int, run_dir: Path) -> None:
    cmd = [
        sys.executable, "-m", "photoinjector_rl.surrogates.mlp.train_ppo",
        "--ckpt", args.ckpt, "--norm-json", args.norm_json,
