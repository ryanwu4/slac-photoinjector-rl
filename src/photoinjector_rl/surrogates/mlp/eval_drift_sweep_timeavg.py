...
Usage:
    python -m photoinjector_rl.surrogates.mlp.eval_drift_sweep_timeavg \
...
def _parse_args() -> argparse.Namespace:
    ...
    p.add_argument("--runs-root", default="runs/compare_diff_hifi")
    p.add_argument("--out-dir", default="results/eval_drift_sweep_timeavg")
