"""
Shared, surrogate-agnostic parameter space for the photoinjector pipeline.

Single source of truth for the 11 XOPT-sampled knob ordering, their bounds, and
the input dimension. Every component (preprocess, train, inference, RL envs)
imports from here so the input-tensor column order is identical everywhere.
"""
